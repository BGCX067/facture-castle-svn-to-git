...
-- 
-- Serveur: localhost
-- Généré le : Lundi 15 Août 2011 à 23:13
...
-- 
-- Contenu de la table `arn_codepostal`
-- 
...
CREATE TABLE `arn_etat_paiement` (
...
CREATE TABLE `arn_moyen_paiement` (
...
CREATE TABLE `arn_relation_facture_produits` (
