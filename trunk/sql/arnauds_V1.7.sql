...
--
-- Client: 127.0.0.1
-- Généré le : Mer 12 Octobre 2011 à 20:52
...
(7, '2011-10-11', 'SCEA château des Arnauds', 'Sebastien Godineau', 'Jerome Godineau', '', 'Compte rendu de la gérance du château des Arnauds du mois de ', 'La vigne :', 'vigne', 'Le chai :', 'chai', 'Commerce :', 'commerce', 'Ventes du mois :', 'Bouteille 2005 (75cl) - BORDEAUX : 2 \nBouteille 2005 (75cl) - LALANDE DE POMEROL : 1 \n');
...
CREATE TABLE IF NOT EXISTS `arn_frais_port` (
  ...
  `tranche1` double(10,2) NOT NULL,
  `tranche2` double(10,2) NOT NULL,
  `tranche3` double(10,2) NOT NULL,
  `tranche4` double(10,2) NOT NULL,
  `tranche5` double(10,2) NOT NULL,
  `tranche6` double(10,2) NOT NULL,
  `tranche7` double(10,2) NOT NULL,
  `tranche8` double(10,2) NOT NULL,
  `tranche9` double(10,2) NOT NULL,
  `tranche10` double(10,2) NOT NULL,
  `tranche11` double(10,2) NOT NULL,
  `tranche12` double(10,2) NOT NULL,
...
(2, 30.00, 31.00, 32.00, 33.00, 34.00, 35.00, 36.00, 37.00, 38.00, 39.00, 40.00, 44.00, 3);
...
(1, 'Création'),
(2, '16,17,24,33,40,47'),
(3, '19,31,32,46,64,65,79,82,85,85,87'),
(6, '91,92,93');
...
(2, 'tranche2', 13, 24),
(3, 'tranche3', 25, 45),
(4, 'tranche4', 1111, 2222),
(5, 'tranche5', 1111, 2222),
(6, 'tranche6', 543, 5654),
(7, 'tranche7', 1111, 2222),
(8, 'tranche8', 1111, 2222),
(9, 'tranche9', 1111, 2222),
(10, 'tranche10', 1111, 2222),
(11, 'tranche11', 1111, 2222),
(12, 'tranche12', 1, 2);
