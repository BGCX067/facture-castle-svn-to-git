...
public class TableModifierEtatPaiement extends AbstractTableModel implements TableModelListener{
	 ...
	 * @param title
	 */
	public TableModifierEtatPaiement(Object[][] data, String[] title){
		this.data = data;
		this.title = title;
	}
	/**
