...
public class TableModifierModePaiement extends AbstractTableModel implements TableModelListener{
	 ...
	 * @param title
	 */
	public TableModifierModePaiement(Object[][] data, String[] title){
		this.data = data;
		this.title = title;
	}
	/**
